...
class ConfigForm(forms.Form):
    ...
    s3bucket = forms.CharField(label="S3 bucket", widget=forms.TextInput(attrs={'size': 80}))
    s3region = forms.CharField(label="S3 region", widget=forms.TextInput(attrs={'size': 80}))
